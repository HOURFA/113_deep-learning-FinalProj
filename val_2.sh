...
chmod +x val.sh
# 設定 Python 腳本的路徑
PYTHON_SCRIPT="/home/rfa/NTUST/LAB/A-Yolom/ultralytics/val_plot_ori_pruned_quantized.py"
RESULTS_FILE="/home/rfa/NTUST/LAB/A-Yolom/results_ori_pruned_quantized.csv"
