        ...
        for batch_i, batch in enumerate(bar):
            ...
            if self.args.speed and batch_i==0:
                ...
                with torch.no_grad():
                    ...
                    self.elapsed_time = 1/elapsed_time
                    #----------------------------------------------------------------------------------RFA
            ...
            with dt[1]:
                if self.args.task == 'multi':
                    ...
                    if isinstance(preds_list[0], tuple):
                        pass
                    elif preds_list[0].ndim != 3:
                        preds_list = preds_list[::-1]
                        preds_list[1], preds_list[2] = preds_list[2], preds_list[1]
                    #-----------------------------------RFA
                else:
